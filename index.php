...
<!-- Switcher -->
<?php include('includes/switcher couleur.php');?>
<!-- /Switcher -->  
      ...
      <div class="row">
       <div class="col-md-5 col-md-push-7">
           <div class="banner_content">
            ...
            <p>Nous avons beaucoup de voitures à choisir</p>
            <a href="includes/lire la suite.php" class="btn">Lire la suite <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a> </div>
        </div>
      </div>
    </div>
  </div>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2><span>Trouvez </span><a>la meilleure voiture</a> <span>pour vous</span></h2>
     <p><strong>Informations à propos les services du site</strong></p>
    </div>
    <div class="row"> 
      ...
      <!-- Nouvelles voitures récemment répertoriées -->
...
<div class="car-info-box"> <a href="détails véhicule.php?vhid=<?php echo htmlentities($result->id);?>"><img src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage1);?>" class="img-responsive" alt="image"></a>
<ul>
...
<h6><a href="détails véhicule.php?vhid=<?php echo htmlentities($result->id);?>"><?php echo htmlentities($result->BrandName);?> , <?php echo htmlentities($result->VehiclesTitle);?></a></h6>
...
<!--bas de page -->
<?php include('includes/bas de page.php');?>
<!-- /bas de page--> 
...
<!--Login-Form -->
<?php include('includes/identifier.php');?>
<!--/Login-Form --> 
...
<?php include('includes/mot de passe oublié.php');?>
<!--/Forgot-password-Form --> 
